...
const I18N = {
  es: {
    ...
    "rule.discover": "DESCUBRE",
    "rule.discoverBody": "Encuentra al Mago rival oculto entre sus cartas.",
    "rule.attack": "ATACA",
    "rule.attackBody": "Lanza tus ataques y domina las ventajas elementales.",
    "rule.magic": "DESATA LA MAGIA",
    "rule.magicBody": "Usa Bendiciones y Maldiciones para cambiar el rumbo de la partida.",
    "rule.win": "VENCE",
    "rule.winBody": "Golpea al Mago 3 veces y reclama la victoria.",
  ...
  en: {
    ...
    "rule.discover": "DISCOVER",
    "rule.discoverBody": "Find the rival Mage hidden among their cards.",
    "rule.attack": "ATTACK",
    "rule.attackBody": "Launch your attacks and master the elemental advantages.",
    "rule.magic": "UNLEASH THE MAGIC",
    "rule.magicBody": "Use Blessings and Curses to change the course of the match.",
    "rule.win": "WIN",
    "rule.winBody": "Hit the Mage 3 times and claim victory.",
